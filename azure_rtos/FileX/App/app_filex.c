...
UINT MX_FileX_Init(VOID *memory_ptr)
{
  ...
  /* Skip thread creation - NetXDuo webserver handles FileX operations */
    /* Initialize FileX only */
...
void fx_app_thread_entry(ULONG thread_input)
{
  ...
  nor_sim_status =  fx_media_format(&nor_simulator_flash_disk,                                                                     // nor_simulator_flash_disk pointer
                                    ...
                                    ((LX_NOR_SIMULATOR_FLASH_SIZE - LX_NOR_SIMULATOR_SECTOR_SIZE) / FX_NOR_SIMULATOR_SECTOR_SIZE), // Total sectors minus one
